...
spdadd 2001:db8:1234::2/64 2001:db8:1234::3/64 any -P out ipsec \
    esp/tunnel/10.0.0.1-10.0.3.2/require;

spdadd 2001:db8:1234::3/64 2001:db8:1234::2/64 any -P in ipsec \
    esp/tunnel/10.0.3.2-10.0.0.1/require;


spdadd 2001:db8:1234::2/64 2001:db8:1234::3/64 any -P in none;

spdadd 2001:db8:1234::3/64 2001:db8:1234::2/64 any -P out none;
